...
var phoneRouter = require('./routes/phoneRouter'); // the logic of phonerouter is provided in phonerouter
...
const url = 'mongodb://localhost:27017/phoneshop'; //needed for connecting the server to a localhost MongoDB at the default port and our database name is phoneshop
...
app.use('/phones', phoneRouter); //use the phone router when there is a request at localhost:3000/phones
// app.use('/', userRouter);
